...
public class Palindromo {
    ...
    int contador=0;
        ...
        do {            
            calculos=Integer.parseInt(JOptionPane.showInputDialog(null,"Digite una opcion: \n"+
                    "1- Palindromo \n"+
                    "2- Repetir \n"+ 
                    "3- Salir"));
            ...
            switch(calculos){
                    ...
                    case 1:
                        ...
                        if(objclass.espalindromo(nuevo)){
                            System.out.println("La palabra que digito en un palindromo");
                        }
                        else
                        {
                            System.out.println("La palabra que digito no es un palindromo");
                        }
                    break;
                    case 2:
